...
export function SpaceCard({
  ...
  return (
    <div className="flex flex-col justify-between rounded-3xl bg-surface-container-lowest p-6 shadow-sm transition-transform duration-300 hover:-translate-y-1">
